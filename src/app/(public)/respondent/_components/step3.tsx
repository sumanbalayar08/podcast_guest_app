...
export default function Step3() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="pt-4 border-gray-200 flex justify-between">
        <button
          type="button"
          onClick={() => router.push("/respondent?step=step2")}
          className="inline-flex justify-center rounded-md text-white border border-transparent cursor-pointer bg-blue-600 py-2 px-4 text-lg font-semibold shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Back
        </button>
        <button
